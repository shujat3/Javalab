...
function recalculate() {
    ...
    var total = 0;
    if (modelName == "XYZ") {
        total = parseFloat(duration) * 100;
    }
    else if (modelName =="CPRG"){
        total = parseFloat(duration) * 213;
    }
...
function changeModel() {
    let Text = document.getElementById("model-text");
    if(modelName == "XYZ") {
        modelName = "CPRG";
        Text.innerHTML = "Model" + "" + modelName;
    }
    else if(modelName == "CPRG") {
        modelName = "XYZ";
        Text.innerHTML = "Model" + "" + modelName;
...
var Button = document.getElementById("duration-button");
